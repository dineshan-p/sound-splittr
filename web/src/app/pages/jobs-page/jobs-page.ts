...
export class JobsPage implements OnInit {
	...
	getStatusIcon(status: string): SafeHtml {
		// These SVGs are static, hardcoded icons — not user input — so it's safe
		// to bypass Angular's sanitization. We use bypassSecurityTrustHtml to
		// render inline SVGs directly in the template without wrapping them in
		// <img> tags or fetching external files.
